      ...
      <div className="min-h-[100vh] sm:min-h-screen w-screen flex flex-col relative bg-[#F2F3F5] font-inter overflow-hidden">
        ...
        <main className="flex flex-col justify-center h-[90%] static md:fixed w-screen overflow-hidden grid-rows-[1fr_repeat(3,auto)_1fr] z-[100] pt-[30px] pb-[320px] px-4 md:px-20 md:py-0">
          <motion.p
            ...
            className="block w-[100px] row-start-2 mb-6 md:mb-4 text-2xl font-bold text-[#1E2B3A]"
          >
            MEDOFF
          </motion.p>
          ...
          >
            Elevate your <br />
            medical <span className="text-[#407BBF]">checkups</span>
          ...
          >
            <div className="w-1/2">
              ...
              <p className="text-[14px] leading-[20px] text-[#1a2b3b] font-normal">
                Full access to our platform, including all questions and medical
                history.
              </p>
            </div>
            <div className="w-1/2">
          ...
          <div className="flex gap-[15px] mt-8 md:mt-0">
            ...
            >
              <Link
                href="https://github.com/tanayvaswani/medoff"
                target="_blank"
        ...
        <div className="h-[60px] bg-[#1D2B3A] fixed bottom-0 z-20 w-full flex flex-row px-[2rem]">
          <p className="text-white/80 text-base md:text-lg font-semibold md:leading-[60px] whitespace-nowrap flex flex-row">
            Meet Doctors from All over the World, Because not all wounds are visible, we, are dedicated to healing the unseen. 
          </p>
        </div>
      </div>
    </AnimatePresence>
